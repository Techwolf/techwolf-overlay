...
if [[ ${PV} == 9999 ]]; then
	...
	SRC_URI="https://github.com/ethereum-mining/${PN}/archive/v${PV/_/}.tar.gz -> ${P}.tar.gz"
	KEYWORDS="~amd64 ~x86"
fi
...
pkg_setup() {
	...
	einfo 
	einfo "If you get \"/usr/include/bits/floatn.h(73): error: identifier \"__float128\" is undefined\" error:"
	einfo "\"sed -i \"1 i#define _BITS_FLOATN_H\" /opt/cuda/include/host_defines.h\" will fix it."
	einfo
}
