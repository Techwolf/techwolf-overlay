...
MY_SOURCE="http://imprudence.googlecode.com/files/Imprudence-source-1.3.0-RC3.zip"
MY_ARTWORK="http://imprudenceviewer.org/download/extras/imprudence-artwork-20100624.tar.bz2"
...
src_prepare() {
	...
	sed -i -e 's/^            self.end_prefix(\"lib32\")/\"\"\"/' indra/newview/viewer_manifest.py || die "Sed manifest fix failed"
