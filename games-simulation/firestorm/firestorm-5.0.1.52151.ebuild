...
MY_SOURCE="https://bitbucket.org/NickyD/phoenix-firestorm-lgpl/get/ab632018105c.tar.bz2"
...
src_unpack() {
	unpack ${MY_SOURCE##*/}
	mv NickyD-phoenix-firestorm-lgpl-ab632018105c linden || die "renaming to \"linden\" failed"
	S="${WORKDIR}/linden"
	cd "${S}"
