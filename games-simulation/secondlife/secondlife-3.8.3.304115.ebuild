...
MY_SOURCE="https://bitbucket.org/lindenlab/viewer-release/get/3.8.3-release.tar.bz2"
...
src_unpack() {
	unpack ${MY_SOURCE##*/}
	mv lindenlab-viewer-release-60572f718879 linden || die "renaming to \"linden\" failed"
	S="${WORKDIR}/linden"
	cd "${S}"
	unpack ${MY_GLH##*/}
